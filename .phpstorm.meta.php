...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\mbc-api\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\mbc-api\\public\\storage','logging.default','logging.deprecations.channel',
...
'sanctum.csrf-cookie','cart.index','cart.add',
'cart.merge','cart.update','cart.remove','cart.clear','cart.toggle-select',
'vouchers.apply','vouchers.remove','admin.dashboard','admin.categories.index','admin.categories.store',
'admin.categories.show','admin.categories.update','admin.categories.destroy','admin.colors.index','admin.colors.store',
'admin.colors.show','admin.colors.update','admin.colors.destroy','admin.sizes.index','admin.sizes.store',
'admin.sizes.show','admin.sizes.update','admin.sizes.destroy','admin.materials.index','admin.materials.store',
'admin.materials.show','admin.materials.update','admin.materials.destroy','admin.products.index','admin.products.store',
'admin.products.show','admin.products.update','admin.products.destroy','admin.vouchers.index','admin.vouchers.store',
'admin.vouchers.show','admin.vouchers.update','admin.vouchers.destroy','admin.','storage.local',);
...
'SESSION_DOMAIN','SESSION_SECURE_COOKIE','SESSION_HTTP_ONLY','SESSION_SAME_SITE','SANCTUM_STATEFUL_DOMAINS',
'FRONTEND_URL','CSRF_COOKIE_NAME','CSRF_HEADER_NAME','FRONTEND_URL','BROADCAST_CONNECTION',
'FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_STORE','CACHE_DRIVER','QUEUE_CONNECTION',
